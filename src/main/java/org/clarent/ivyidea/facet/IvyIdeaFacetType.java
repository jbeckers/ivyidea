...
public class IvyIdeaFacetType extends FacetType<IvyIdeaFacet, IvyIdeaFacetConfiguration> {
  ...
  public IvyIdeaFacetType() {
    super(IvyIdeaConstants.FACET_TYPE_ID, IvyIdeaConstants.FACET_STRING_ID, "IvyIDEA");
  }
  ...
  protected IvyIdeaFacetConfiguration configureDetectedFacet(
      @NotNull final VirtualFile ivyFile,
      @NotNull final Collection<? extends IvyIdeaFacetConfiguration> existingFacetConfigurations) {
