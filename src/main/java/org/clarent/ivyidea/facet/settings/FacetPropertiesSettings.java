...
public class FacetPropertiesSettings implements JDOMExternalizable {
  ...
  @NotNull
  public static FacetPropertiesSettings copyDataFrom(
      @NotNull final FacetPropertiesSettings propertiesSettings) {
    final FacetPropertiesSettings result = new FacetPropertiesSettings();
    result.setPropertyFiles(new ArrayList<>(propertiesSettings.getPropertyFiles()));
    return result;
  }
